...
# 3) Conda environment
Always use the conda environment `pyt` for running scripts. If you add new dependencies, update the environment.yml file and share the exact `conda install` command in your notes for reproducibility.
