...
- hybrid top-5:
  - NIST.FIPS.203 p16-p16 (NIST.FIPS.203::p0016::c000) spec_like=True
  - NIST.FIPS.203 p44-p44 (NIST.FIPS.203::p0044::c001) spec_like=True
  - NIST.FIPS.203 p24-p24 (NIST.FIPS.203::p0024::c000) spec_like=True
...
- hybrid top-5:
  - NIST.FIPS.203 p44-p44 (NIST.FIPS.203::p0044::c001) spec_like=True
  - NIST.FIPS.203 p9-p9 (NIST.FIPS.203::p0009::c002) spec_like=True
  - NIST.FIPS.203 p9-p9 (NIST.FIPS.203::p0009::c001) spec_like=True
  - NIST.FIPS.203 p44-p44 (NIST.FIPS.203::p0044::c002) spec_like=True
  - NIST.FIPS.203 p16-p16 (NIST.FIPS.203::p0016::c000) spec_like=True
...
- base top-5:
  ...
  - NIST.FIPS.203 p23-p23 (NIST.FIPS.203::p0023::c001) spec_like=True
- hybrid top-5:
  - NIST.FIPS.203 p8-p8 (NIST.FIPS.203::p0008::c000) spec_like=True
  - NIST.FIPS.203 p37-p37 (NIST.FIPS.203::p0037::c001) spec_like=True
  - NIST.FIPS.203 p37-p37 (NIST.FIPS.203::p0037::c000) spec_like=True
  - NIST.FIPS.203 p41-p41 (NIST.FIPS.203::p0041::c001) spec_like=True
  - NIST.FIPS.203 p24-p24 (NIST.FIPS.203::p0024::c002) spec_like=True
...
- hybrid top-5:
  ...
  - NIST.FIPS.203 p23-p23 (NIST.FIPS.203::p0023::c002) spec_like=True
  - NIST.FIPS.203 p44-p44 (NIST.FIPS.203::p0044::c001) spec_like=True
  - NIST.FIPS.203 p46-p46 (NIST.FIPS.203::p0046::c000) spec_like=True
